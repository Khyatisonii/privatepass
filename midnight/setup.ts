// Bootstrap step for PrivatePass.
// This is intentionally separate from src/ and should be used only for Midnight
// setup and deployment, not the React demo UI.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up PrivatePass on network: ${network}\n\n`);
